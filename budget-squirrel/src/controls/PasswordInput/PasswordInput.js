...
export default function PasswordInput({ id, classNames, name, valueRef, placeholder, isValid=true }) {
    ...
    return (
        <div class="password-input input input--wrapper">
            <input id={id} class={getClassNames()} name={name} ref={valueRef} placeholder={placeholder} type={inputType} />
