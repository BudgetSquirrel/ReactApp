...
export default function PasswordInput({ id, classNames, name, placeholder }) {
    let classes = `input input--pw ${classNames}`;
    if (!placeholder) placeholder = "Password";
    
    return (
        <div class="password-input input input--wrapper">
            <input id={id} class={classes} name={name} placeholder={placeholder} />
            <div class="password-input__eye">
